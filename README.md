...
Civic Line gives you **enterprise email/sms capabilities with CLI simplicity**, perfect for civic projects that need to move fast.
...
[Open an issue](https://github.com/Next-Voters/Civic-Line/issues) or contribute on GitHub.
